  ...
  return (
    <div className="bg-[#000000] flex flex-col gap-8 px-8 py-[72px]">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <ImageBase.SSIDLogo />
        <p className="w-[1061px] text-5xl text-white text-center ">
      ...
      <div className="w-full flex flex-col gap-8">
        {/* 01 */}
        <div className="w-full flex justify-between items-center pt-4 border-t border-[#333333]">
        ...
        {/* 02 */}
        <div className="w-full flex justify-between items-center pt-4 pb-12 border-y border-[#333333]">
      ...
      <div className="w-full mt-12 flex flex-col gap-6 justify-center items-center">
        <ImageBase.FPTLogo />
        <p className="w-[1061px] text-white text-5xl text-center">

...
export default function AfternoonSection({activeTab} : Props) {
  ...
  return (
      ...
      <div
        ...
        <p className='font-neueMed text-[20px] tablet:text-[40px] tablet:max-w-[334px] leading-[28px] tablet:leading-[48px] opacity-[0.4]'>
        ...
        {hoveredImageAfternoon && (
            <div
                className="hidden tablet:block mt-20 absolute left-[350px] opacity-100 transition-opacity duration-300">
              <Image

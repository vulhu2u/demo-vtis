    ...
    <footer className=" relative w-full p-4 tablet:p-12 bg-gradient-to-t from-[#28D2DC] to-black">
      ...
      <div className="w-full h-full flex flex-col tablet:justify-between">
        ...
        <div className="w-full h-full flex flex-col gap-6 tablet:flex-row justify-center tablet:justify-between items-start">
          <Link
            href="/"
            className="w-full flex tablet:justify-center tablet:w-[300px] laptop:w-auto h-10"
          >
            <ImageBase.LandingLogo width={300} height={10} />
          </Link>
          <div className="tablet:w-[456px] w-[343px] flex flex-col gap-4 tablet:justify-center items-center tablet:text-center">
            <h2 className="font-neueMed text-[48px] tablet:text-[64px] font-medium bg-gradient-to-r from-[#28D2DC] to-[#FFFFFF] bg-clip-text text-transparent">
          ...
          <div className="flex w-full tablet:w-auto justify-between gap-20  ">
            {/* Nav Menu */}
